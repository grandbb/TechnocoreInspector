...
$('#app').innerHTML = `
<a class="skip-link" href="#workspace">Skip to inspection</a><header><div class="brand"><img src="./favicon.svg" alt=""><span>Technocore <span style="color:var(--muted)">Inspector</span></span><span class="tag">COMMUNITY TOOL</span></div><span class="privacy">Local verification · No wallet required</span></header>
<main><div class="heading"><div><div class="eyebrow">TECHNOCORE / MESSAGE VERIFICATION</div><h1>Read messages. Verify the evidence.</h1><p>Check digital signatures and sender identities. Your data stays on your device.</p></div></div>
